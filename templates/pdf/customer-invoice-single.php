<?php
// file: templates/pdf/customer-invoice-single.php
// Expects: $row (invoice), $customer (object), $items (array)
?>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <h1><?php esc_html_e('Invoice','arm-repair-estimates'); ?> #<?php echo esc_html( (string)($row->invoice_no ?? $row->id ?? '') ); ?></h1>
