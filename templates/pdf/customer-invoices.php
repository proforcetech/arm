...
<body>
  ...
  <h1><?php esc_html_e('Customer Invoices','arm-repair-estimates'); ?></h1>
  ...
  <table>
    ...
    <tbody>
      <?php if (!empty($rows)): foreach ($rows as $r): ?>
        <tr>
          <td><?php echo esc_html( (string)($r->invoice_no ?? $r->id ?? '') ); ?></td>
      ...
      <?php endforeach; else: ?>
        <tr><td colspan="4"><?php esc_html_e('No invoices found.','arm-repair-estimates'); ?></td></tr>
      <?php endif; ?>
    </tbody>
  </table>
</body>
